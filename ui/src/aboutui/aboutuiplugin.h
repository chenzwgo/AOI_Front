#ifndef ABOUTUIPLUGIN_H
#define ABOUTUIPLUGIN_H

#include <QObject>
#include "iuiplugin.h"
#include "inotify.h"

class AboutUIService;
class AboutUIPlugin: public QObject, IUIPlugin, INotify
{
    Q_OBJECT
...
private:
    AboutUIService *m_pAboutUIService;
};
