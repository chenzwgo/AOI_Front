#ifndef DEFECTCLASSIFICATIONUIPLUGIN_H
#define DEFECTCLASSIFICATIONUIPLUGIN_H
...
class DefectClassificationUIPlugin: public QObject, IUIPlugin, INotify
{
    Q_OBJECT
...
public:
    DefectClassificationUIPlugin();
    virtual ~DefectClassificationUIPlugin();
    virtual bool init();
    virtual bool uninit();
...
private:
    DefectClassificationUI *m_pDefectClassificationUI;
};

#endif // DEFECTCLASSIFICATIONUIPLUGIN_H
