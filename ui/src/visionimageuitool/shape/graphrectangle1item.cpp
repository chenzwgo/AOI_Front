...
GraphRectangle1Item::GraphRectangle1Item(QGraphicsItem *parent)
...
GraphRectangle1Item::GraphRectangle1Item(const GraphRectangle1Item &other)
{
    m_rect = other.m_rect;
    *this = other;
}

void GraphRectangle1Item::addControls()
{
...
void GraphRectangle1Item::updateControls()
{
    // 设置控制点大小
...
void GraphRectangle1Item::resizeShape(NControlPos pos, const QPointF &point)
{
...
QPainterPath GraphRectangle1Item::getShapePath()
{
    QPainterPath path;
    path.addRect(m_rect);
    ////添加箭头
...
QPainterPath GraphRectangle1Item::getOutSidePath()
{
    QPainterPath path;
    QRectF rect;
...
void GraphRectangle1Item::contextMenuEvent(QGraphicsSceneContextMenuEvent *event)
{
}

QVariant GraphRectangle1Item::shapeData(DataType type)
{
    QVariant var;
    switch (type)
    {
...
GraphicsShapeItem * GraphRectangle1Item::copy()
{
    return new GraphRectangle1Item(*this);
}

bool GraphRectangle1Item::setShapeData(const QVariant &data)
{
...
QVariant GraphRectangle1Item::shapeData()
{
