#ifndef GRAPHICSPOINTSITEM_H
#define GRAPHICSPOINTSITEM_H

#include "shape/graphshapeitem.h"

class GraphicsPointsItem : public GraphicsShapeItem
{
public:
    GraphicsPointsItem(QGraphicsItem *parent = NULL);
    GraphicsPointsItem(const GraphicsPointsItem &other);
