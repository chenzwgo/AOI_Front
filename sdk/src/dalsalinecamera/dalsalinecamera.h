...
class CDalsaLineCamera : public ILineCamera
{
public:
    CDalsaLineCamera(const char *pszGUID);
    ~CDalsaLineCamera(void);
...
private:
	...
	uint64                   m_latestTime;
public:
    JThreadTP<CDalsaLineCamera, void*, void>*    m_pThreadOpenCam;
};
