...
#define CORSERVER_MAX_NUMBER		256
...
// Multispectral RGB-IR formats: RGB at left, MONO at right of the buffer
...
#define CORDATA_FORMAT_MONO8P4      (CORDATA_FORMAT( 4, 40,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P4     (CORDATA_FORMAT( 4, 41, 16) | CORDATA_FORMAT_UNSIGNED)

#define CORDATA_FORMAT_COORD3D_C16     (CORDATA_FORMAT( 1, 42, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_COORD3D_AC16    (CORDATA_FORMAT( 2, 43, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_COORD3D_CR16    (CORDATA_FORMAT( 2, 44, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_COORD3D_ACRW16  (CORDATA_FORMAT( 4, 45, 16) | CORDATA_FORMAT_UNSIGNED)
// Obsolete
#define CORDATA_FORMAT_COORD3D_ACR016  CORDATA_FORMAT_COORD3D_ACRW16

// Multispectral RGB-IR formats (RGB in plan #0, IR in plan #1): defined here but not yet implemented in the buffer and the view modules.
#define CORDATA_FORMAT_RGB888_MONO8P2       (CORDATA_FORMAT( 2, 46, 32) | CORDATA_FORMAT_COLORI)
#define CORDATA_FORMAT_RGB161616_MONO16P2   (CORDATA_FORMAT( 2, 47, 64) | CORDATA_FORMAT_COLORI)

// Bicolor 12 bit packed
#define CORDATA_FORMAT_BICOLOR1212 (CORDATA_FORMAT( 1, 48, 24) | CORDATA_FORMAT_COLORI)

// add new formats here!

// Update next definition when new formats are added
#define CORDATA_FORMAT_MAX             49
...
#define CORDATA_FORMAT_RGBAP8    (CORDATA_FORMAT( 4, 1, 8) | CORDATA_FORMAT_PLANAR_TYPE_RGB)
#define CORDATA_FORMAT_RGBAP16   (CORDATA_FORMAT( 4, 2, 16) | CORDATA_FORMAT_PLANAR_TYPE_RGB)
...
#define CORDATA_FORMAT_IS_MULTI(x) (										\
   ...
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P4)) || \
   ...
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P4)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_COORD3D_AC16)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_COORD3D_CR16)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_COORD3D_ACRW16)))
...
#define CORDATA_FORMAT_IS_BICOLOR(x) (                   \
   ...
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_BICOLOR1212)) || \
...
#define CORDATA_FORMAT_IS_MONO(x) ( \
   ...
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_MONO16P3)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_MONO16P4)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_C16)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_AC16)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_CR16)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_ACRW16)))

#define CORDATA_FORMAT_IS_COORD_3D(x) ( \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_C16))  || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_AC16)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_CR16)) || \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_ACRW16)))
...
#define  CORPORT_TYPE_XTIUMCXPPX8CAMSIM   104
#define  CORPORT_TYPE_XTIUMCLHSPX8CAMSIM  105
#define  CORPORT_TYPE_XTIUMSFPMPX4CAMSIM  106
#define  CORPORT_TYPE_XTIUM2CLHSPX8       107
#define  CORPORT_TYPE_XTIUM2CLHSPX8CAMSIM 108
#define  CORPORT_TYPE_XTIUM2SFPXPX8CAMSIM 109
#define  CORPORT_TYPE_XTIUM2SFPXPX8	      110
#define  CORPORT_TYPE_XTIUM2CLHSFX8LC	   111
#define  CORPORT_TYPE_XTIUM2CLHSPX8LC     112
#define  CORPORT_TYPE_XTIUM2CXPPX8        113
...
#define  CORSIGNAL_DOUBLE_PULSE_RISING_EDGE_ORDER_REVERSE  0x00000080
#define  CORSIGNAL_DOUBLE_PULSE_FALLING_EDGE_ORDER_REVERSE 0x00000100
