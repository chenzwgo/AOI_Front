...
#define CORDATA_PACK_BICOLOR1212_RG(pData, pBuf) \
   {\
      *((UINT8 *)(pBuf)+0 )= (UINT8)((pData)->rgb.red >> 4); \
      *((UINT8 *)(pBuf)+1 )= (UINT8)((((pData)->rgb.red & 0x0F) << 4) | ((pData)->rgb.green & 0x0F)); \
      *((UINT8 *)(pBuf)+2 )= (UINT8)((pData)->rgb.green >> 4); \
   }

#define CORDATA_PACK_BICOLOR1212_BG(pData, pBuf) \
   {\
      *((UINT8 *)(pBuf)+0 )= (UINT8)((pData)->rgb.blue >> 4); \
      *((UINT8 *)(pBuf)+1 )= (UINT8)((((pData)->rgb.blue & 0x0F) << 4) | ((pData)->rgb.green & 0x0F)); \
      *((UINT8 *)(pBuf)+2 )= (UINT8)((pData)->rgb.green >> 4); \
   }
...
#define CORDATA_PACK_COORD3D_C16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)) = (UINT16) (pData)->coord3d.c; \
	}

#define CORDATA_PACK_COORD3D_AC16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)  ) = (UINT16) (pData)->coord3d.a; \
   *((UINT16 *)(pBuf)+1) = (UINT16) (pData)->coord3d.c; \
	}

#define CORDATA_PACK_COORD3D_CR16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)  ) = (UINT16) (pData)->coord3d.c; \
   *((UINT16 *)(pBuf)+1) = (UINT16) (pData)->coord3d.r; \
	}

#define CORDATA_PACK_COORD3D_ACRW16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)  ) = (UINT16) (pData)->coord3d.a;        \
   *((UINT16 *)(pBuf)+1) = (UINT16) (pData)->coord3d.c;        \
   *((UINT16 *)(pBuf)+2) = (UINT16) (pData)->coord3d.r;        \
   *((UINT16 *)(pBuf)+3) = (UINT16) (pData)->coord3d.reserved; \
	}
...
#define CORDATA_UNPACK_BICOLOR1212_RG(pBuf, pData) \
   {\
      UINT8* pBuf8= (UINT8*)pBuf;\
      (pData)->rgb.red  = (INT32) ((pBuf8[0] << 4) | (pBuf8[1] >> 4));\
      (pData)->rgb.green= (INT32) ((pBuf8[2] << 4) | (pBuf8[1] & 0x0F));\
      (pData)->rgb.blue = 0;\
   }

#define CORDATA_UNPACK_BICOLOR1212_BG(pBuf, pData) \
      {\
      UINT8* pBuf8= (UINT8*)pBuf;\
      (pData)->rgb.red  = 0;\
      (pData)->rgb.green= (INT32) ((pBuf8[2] << 4) | (pBuf8[1] & 0x0F));\
      (pData)->rgb.blue = (INT32) ((pBuf8[0] << 4) | (pBuf8[1] >> 4));\
      }
