...
enum _SapFormat
{
   ...
   SapFormatBICOLOR1212 = CORDATA_FORMAT_BICOLOR1212,
   ...
   // 3D formats
   SapFormatCoord3D_C16    = CORDATA_FORMAT_COORD3D_C16,
   SapFormatCoord3D_AC16   = CORDATA_FORMAT_COORD3D_AC16,
   SapFormatCoord3D_CR16   = CORDATA_FORMAT_COORD3D_CR16,
   SapFormatCoord3D_ACRW16 = CORDATA_FORMAT_COORD3D_ACRW16,
   ...
   SapFormatRGBAP8  = CORDATA_FORMAT_RGBAP8,      // 8-bit RGB + Alpha
   SapFormatRGBAP16 = CORDATA_FORMAT_RGBAP16,     // 16-bit RGB + Alpha
   SapFormatRGB888_MONO8P2  = CORDATA_FORMAT_RGB888_MONO8P2,
   SapFormatRGB161616_MONO16P2  = CORDATA_FORMAT_RGB161616_MONO16P2,
};
...
class SAPCLASSBASIC_CLASS SapDataCoord3D : public SapData
{
public:
   // Constructors
   SapDataCoord3D()
      { m_Type = SapFormatTypeCoord3D; }
   SapDataCoord3D(int a, int c, int r, int reserved = 0)
      { m_Type = SapFormatTypeCoord3D; m_Data.coord3d.a = (UINT16)a; m_Data.coord3d.c = (UINT16)c; m_Data.coord3d.r = (UINT16)r; m_Data.coord3d.reserved = (UINT16)reserved;}
   SapDataCoord3D(const SapData &data)
      { m_Type = SapFormatTypeCoord3D; m_Data = data.GetData(); }

   SapDataCoord3D &operator=(const SapData &data) { m_Type = SapFormatTypeCoord3D; m_Data = data.GetData(); return *this; }

   // Data access methods
   int A()        { return m_Data.coord3d.a; }
   int C()        { return m_Data.coord3d.c; }
   int R()        { return m_Data.coord3d.r; }
   int Reserved() { return m_Data.coord3d.reserved; }

   void Set(int a, int c, int r, int reserved) { m_Data.coord3d.a = (UINT16)a; m_Data.coord3d.c = (UINT16)c; m_Data.coord3d.r = (UINT16)r; m_Data.coord3d.reserved= (UINT16)reserved;}
};
