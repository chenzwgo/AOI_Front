...
private:
    virtual bool setJogPrm(TJogPrm &jogprm);			// 设置jog运动模式参数
    virtual bool getJogprm(TJogPrm &jogprm);		// 获取jog运动模式参数
    virtual bool setPrfJog();						// 设置为jog运动模式
    virtual bool setPrfTrap();						// 设置指定轴为点位运动模式
    virtual bool setTrapPrm(TTrapPrm prm);			// 设置点位运动模式参数
    virtual bool getTrapPrm(TTrapPrm &prm);			// 获取点位运动模式参数
