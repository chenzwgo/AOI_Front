...
#define WATCH_ADDRESS_TYPE_POS_ERR                              (40)          //16.0
...
typedef struct PosControlConfig
{
    short active;
    short axis;
    short encoder1;
...
//Added by Jia Songtao
GT_API GT_SetPosLoopStr(short cardNum, short control, TPosCtrlStrCfg *pPosCtrl);
GT_API GT_GetPosLoopStr(short cardNum, short control, TPosCtrlStrCfg *pPosCtrl);
...
GT_API GT_PrintWatch(short cardNum,const char *pFileName);
