...
public:
  ...
  void Initialize(string const iniPath);   //≥ı ºªØ
  ...
  unsigned long   GetValueul(string const keyname, string const valuename, unsigned long const defValue = 0) const;
  bool   GetValueB(string const keyname, string const valuename, bool const defValue = false) const 
  {
	//new revise by ycy 2015-5-18 avoid of warnning C4800
	int iRtnVal = GetValueI(keyname, valuename, int( defValue));
    if (0 == iRtnVal)
	{
		return false;
	}
  ...
  float   GetValueF(string const keyname, string const valuename, float const defValue = 0.0) const;
  double   GetValueD(string const keyname, string const valuename, double const defValue = 0.0) const;
  ...
  bool SetValueF( string const keyname, string const valuename, float const value, bool const create = true);
  bool SetValueD( string const keyname, string const valuename, double const value, bool const create = true);
