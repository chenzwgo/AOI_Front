...
// Color RGB data format with components ordered as R -> G -> B
   ...
   {CORDATA_FORMAT_MONO8P4, (UINT32)-1},	                  // 53
	{CORDATA_FORMAT_MONO16P4, (UINT32)-1},	                  // 54

   // 3D formats
   {CORDATA_FORMAT_COORD3D_C16, (UINT32)-1},	               // 55
   {CORDATA_FORMAT_COORD3D_AC16, (UINT32)-1},	            // 56
   {CORDATA_FORMAT_COORD3D_CR16, (UINT32)-1},	            // 57
   {CORDATA_FORMAT_COORD3D_ACRW16, (UINT32)-1},	            // 58

   {CORDATA_FORMAT_RGB888_MONO8P2, (UINT32)-1},	            // 59       
   {CORDATA_FORMAT_RGB161616_MONO16P2, (UINT32)-1},	      // 60
	{CORDATA_FORMAT_RGBAP8,		(UINT32)-1},						// 61
	{CORDATA_FORMAT_RGBAP16,		(UINT32)-1},					// 62

	{CORDATA_FORMAT_BICOLOR1212,	(UINT32)-1},	            // 63
};
