#ifndef WORK_WAIT_CONDITION_H
#define WORK_WAIT_CONDITION_H
...
struct stWaitVarCondition
{
    ...
    stWaitVarCondition& operator=(const stWaitVarCondition &other)
    {
        if (this == &other)
        {
            return *this;
    ...
    bool operator==(const stWaitVarCondition &other)
    {
...
struct WORK_WAIT_CONDITION : ACTION_PARAM
{
    map<string, bool>  mapIo;   // IO条件列表
    vector<stWaitVarCondition>  vecVar; // 变量条件列表
    ...
    WORK_WAIT_CONDITION& operator=(const WORK_WAIT_CONDITION &other)
    {
        if (this == &other)
        {
            return *this;
    ...
    bool operator==(const WORK_WAIT_CONDITION &other)
    {
