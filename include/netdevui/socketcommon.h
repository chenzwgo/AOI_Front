...
public:
   ...
   static  bool isSocketReadable(int iSocket);
    ...
    static int sendexUDP(int iSocket, const char* pDesIP, unsigned int iDesPort,  char* pBuf, unsigned int ilen, int &sendLength, int timeout= 500);

    static int recvexUDP(int iSocket, const char* pDesIP, unsigned int iDesPort,  char* pBuf, unsigned int ilen, int &recvLength, int timeout= 500);
